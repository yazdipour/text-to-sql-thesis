...
\begin{enumerate}
    \item \textbf{Give ChatGPT an identity and intended audience}: By assigning a role or identity to ChatGPT (e.g., "You are a text-to-sql assistant, do... or As an assistant, explain...") and specifying the target audience, the model can adopt a specific perspective or tone, providing tailored responses to the context.
