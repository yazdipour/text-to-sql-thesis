...
\begin{figure}[H]
  ...
  \caption{A difficult text-to-SQL task from the Spider dataset.\cite{wang_rat_sql_2021}}
  \label{fig:Spider3}
\end{figure}
...
%     print("Hello, World!")
%     \end{verbatim}
%             \caption{Caption for code snippet 1}
%         \end{minipage} &
%         \begin{minipage}{0.45\textwidth}
%             \begin{verbatim}
%     # Code snippet 2
%     print("Goodbye, World!")
%     \end{verbatim}
%             \caption{Caption for code snippet 2}
%         \end{minipage} \\
...
%     print("Howdy, World!")
%     \end{verbatim}
%             \caption{Caption for code snippet 3}
%         \end{minipage} &
%         \begin{minipage}{0.45\textwidth}
%             \begin{verbatim}
%     # Code snippet 4
...
%     \end{verbatim}
%             \caption{Caption for code snippet 4}
%         \end{minipage} \\
%     \end{tabular}
